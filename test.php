...
STARTTABLE;
        ...
        foreach($accepted as $k=>$v){
            ...
            <tr style="background-color: #99FF99;">
                ...
                <td>{$v['trim']}</td>
                <td>$amount</td>
                <td><a href="#myModal" role="button" class="btn" data-toggle="modal" data-load-remote="http://onlinelotbuilder.com/includes/buyerinfo.php?req=$req" data-remote-target="#myModal .modal-body">Btn $req</a></td>

                <!--<td><a href="#myModal" role="button" class="btn" data-toggle="modal" data-load-remote="" data-target="#myModal .modal-content"><span class="glyphicon glyphicon-user"></span></td>-->
            </tr>
MIDSECTION;
        }
...
<a data-toggle="modal" class="btn btn-info" href="http://onlinelotbuilder.com/includes/buyerinfo.php?req=14" data-target="#myModal">Click me !</a>

<!--
        
<a href="#myModal" role="button" class="btn" data-toggle="modal" data-load-remote="http://onlinelotbuilder.com/includes/buyerinfo.php?req=14" data-remote-target="#myModal .modal-body">Btn 1</a>    
<a href="#myModal" role="button" class="btn" data-toggle="modal" data-load-remote="http://onlinelotbuilder.com/includes/buyerinfo.php?req=19" data-remote-target="#myModal .modal-body">Btn 2</a>
<a href="#myModal" role="button" class="btn" data-toggle="modal" data-load-remote="http://onlinelotbuilder.com/includes/buyerinfo.php?req=DUMB" data-remote-target="#myModal .modal-body">Btn 3</a>
-->
<!-- Modal -->
